...
public class FCadFormaPagamento extends javax.swing.JFrame {

    ClasseFormaPagamento classeformapgto = new ClasseFormaPagamento();
    ...
    private void initComponents() {
        ...
        jCbpesquisa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Geral", "Código", "Forma de Pagamento" }));
    ...
    private void jTfcodigoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTfcodigoFocusLost
        if (!jTfcodigo.getText().equals("")) {
            getcomp();
            dao.retornardados(classeformapgto);
            setcomp();
        }
    ...
    private void jBpesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBpesquisaActionPerformed
        switch (jCbpesquisa.getSelectedIndex()) {
            case 0:
                dao.consultargeral(classeformapgto);
                break;
            case 1:
                classeformapgto.setId_forma_pagamento(Integer.parseInt(jTfPesquisa.getText()));
                dao.consultacodigo(classeformapgto);
                break;
            case 2:
                classeformapgto.setDs_forma(jTfPesquisa.getText());
    ...
    private void jTConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTConsultaMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            classeformapgto.setId_forma_pagamento(Integer.parseInt(codigo));
            dao.retornardados(classeformapgto);
            setcomp();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FCadFormaPagamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FCadFormaPagamento().setVisible(true);
            }
        });
    }
