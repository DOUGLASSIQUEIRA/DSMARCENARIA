...
import br.projetotcc.dao.DaoTipoProduto;
...
public class FCadTipoProduto extends javax.swing.JFrame {
    
    ClasseTipoProduto classetipoproduto = new ClasseTipoProduto();
    ...
    private void jTfcodigoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTfcodigoFocusLost
        if (!jTfcodigo.getText().equals("")) {
            getcomp();
            dao.retornardados(classetipoproduto);
            setcomp();
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
         if (validacampos.retorno != 1) {
            ...
            if (jTfdescricao.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Informe o Tipo de Produto");
                jTfdescricao.grabFocus();
                return;
                ...
                if (situacao == Rotinas.Incluir) {
                    dao.incluir(classetipoproduto);
                    jTfcodigo.setText(Integer.toString(classetipoproduto.getId_tipo_produto()));
                } else if (situacao == Rotinas.Alterar) {
                    dao.alterar(classetipoproduto);
                }
            }
        }
    ...
    private void jBpesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBpesquisaActionPerformed
        switch (jCbpesquisa.getSelectedIndex()) {
            case 0:
                dao.consultargeral(classetipoproduto);
                break;
            case 1:
                classetipoproduto.setId_tipo_produto(Integer.parseInt(jTfPesquisa.getText()));
                dao.consultacodigo(classetipoproduto);
                break;
            case 2:
                classetipoproduto.setDs_tipo_produto(jTfPesquisa.getText());
                dao.consultadescricao(classetipoproduto);
                break;
        }
        preencher.PreencherJtabelaGenerico(jTConsulta, new String[]{"cd_tipo_produto", "ds_tipo_produto"}, classetipoproduto.getRetorno());
    ...
    private void jTConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTConsultaMouseClicked
       if (evt.getClickCount() == 2) {
            ...
            classetipoproduto.setId_tipo_produto(Integer.parseInt(codigo));
            dao.retornardados(classetipoproduto);
            setcomp();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FCadTipoProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FCadTipoProduto().setVisible(true);
            }
        });
    }
 ...
 public ClasseTipoProduto getcomp() {
        if (situacao == Rotinas.Alterar) {
            classetipoproduto.setId_tipo_produto(Integer.parseInt(jTfcodigo.getText()));
        }
        classetipoproduto.setDs_tipo_produto(jTfdescricao.getText());
        return classetipoproduto;

    }

    public void setcomp() {
        jTfcodigo.setText(Integer.toString(classetipoproduto.getId_tipo_produto()));
        jTfdescricao.setText(classetipoproduto.getDs_tipo_produto());
    }
