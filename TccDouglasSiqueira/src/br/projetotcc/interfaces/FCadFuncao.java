...
import br.projetotcc.dao.DaoFuncao;
...
public class FCadFuncao extends javax.swing.JFrame {
    ...
    ClasseFuncao classefuncao = new ClasseFuncao();
    DaoFuncao dao = new DaoFuncao();
    ...
    private void jTfcodigoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTfcodigoFocusLost
        if (!jTfcodigo.getText().equals("")) {
            getcomp();
            dao.retornardados(classefuncao);
            setcomp();
        }
         ...
         if (validacampos.retorno != 1) {
            ...
            if (jTfdescricao.getText().equals("")) {
                ...
                if (situacao == Rotinas.Incluir) {
                    dao.incluir(classefuncao);
                    jTfcodigo.setText(Integer.toString(classefuncao.getId_funcao()));
                } else if (situacao == Rotinas.Alterar) {
                    dao.alterar(classefuncao);
                }
            }
        }
    ...
    private void jBpesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBpesquisaActionPerformed
        switch (jCbpesquisa.getSelectedIndex()) {
            case 0:
                dao.consultargeral(classefuncao);
                break;
            case 1:
                classefuncao.setId_funcao(Integer.parseInt(jTfPesquisa.getText()));
                dao.consultacodigo(classefuncao);
                break;
            case 2:
                classefuncao.setDs_funcao(jTfPesquisa.getText());
    ...
    private void jTConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTConsultaMouseClicked
       if (evt.getClickCount() == 2) {
            ...
            classefuncao.setId_funcao(Integer.parseInt(codigo));
            dao.retornardados(classefuncao);
            setcomp();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FCadFuncao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
 ...
 public ClasseFuncao getcomp() {
        if (situacao == Rotinas.Alterar) {
            classefuncao.setId_funcao(Integer.parseInt(jTfcodigo.getText()));
        }
        classefuncao.setDs_funcao(jTfdescricao.getText());
        return classefuncao;
    ...
    public void setcomp() {
        jTfcodigo.setText(Integer.toString(classefuncao.getId_funcao()));
        jTfdescricao.setText(classefuncao.getDs_funcao());
    }
